...
var (
	...
	DNSRecordGroupKind        = schema.GroupKind{Group: Group, Kind: DNSRecordKind}
...
// SSLCertificate type metadata.
var (
	SSLCertificateKind             = reflect.TypeOf(SSLCertificate{}).Name()
	SSLCertificateGroupKind        = schema.GroupKind{Group: Group, Kind: SSLCertificateKind}
